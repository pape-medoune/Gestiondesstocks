          ...
          <tbody className=""> 
            {currentItems.map((ele) => (
              ...
              >
                ...
                <td className="px-6 py-4    w-fit h-fit flex justify-end items-center ">{ele.description}</td>
                <td className="px-6 py-4  w-fit h-fit flex justify-end items-center">{ele.prix}</td>
