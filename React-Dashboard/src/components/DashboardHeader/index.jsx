...
function DashboardHeader ({ btnText, onClick }) {
  ...
  useEffect(() => {
    ...
    const createElement = async (e) => { 
      e.preventDefault();
    axios.post("http://localhost:4400/add",{nomproduit ,description,prix,image})
    .then(response => {
      console.log("Data inserted successfully"+response.json());
      setElement(response.json());
        ...
        <div className='dashbord-header-container'>
            ...
            <div className='dashbord-header-right'>
                ...
                <img
                    ...
                    src='https://reqres.in/img/faces/9-image.jpg' alt="avatar" />
            </div>
        </div>
    )
}
