    ...
    return(
      ...
      <header className='text-gray-600 body-font w-full'>
        <div className=" w-full container shadow-lg  mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center justify-between">
          ...
          <Link className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0" to='/adminpage'>Admin Page
